...
{
    NSFetchRequest * fr = [NSFetchRequest fetchRequestWithEntityName:@"Contact"];

    NSSortDescriptor * sd = [NSSortDescriptor sortDescriptorWithKey:@"name" ascending:YES];
    [fr setSortDescriptors:@[sd]];
    
    NSArray * read_contacts = [self.managedObjectContext executeFetchRequest:fr error:nil];

    return [read_contacts mutableCopy];
}
